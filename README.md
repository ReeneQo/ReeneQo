...
Работаю с React и Next.js, активно углубляюсь в backend разработку с Nest.js.
...
- Двигаюсь к полноценной фуллстек-специализации
- Разрабатываю личные pet-проекты 
